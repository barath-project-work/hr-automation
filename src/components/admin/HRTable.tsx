...
export function HRTable({ hrs, onToggleActive, onResetPassword }: HRTableProps) {
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            placeholder="Search HRs by name or username..."
                ...
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-gray-900">{hr.full_name}</span>
                    </div>
                  </td>
