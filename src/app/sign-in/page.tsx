        ...
        <div className="w-full max-w-sm mx-auto animate-slide-up">
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-2xl border border-gray-200">
            ...
            <div className="space-y-1 text-xs text-gray-600">
              <p><span className="font-mono font-medium text-gray-900">admin</span> / <span className="font-mono font-medium text-gray-900">Admin@123</span> — Admin Panel</p>
              <p><span className="font-mono font-medium text-gray-900">hr_name</span> / <span className="font-mono font-medium text-gray-900">(any 8+ chars)</span> — HR Dashboard</p>
            </div>
          </div>
        </div>
      </div>
